...
export default function ProjectINFRA() {
  const [params, setParams] = useSearchParams();
  const page = Math.max(1, Number(params.get("page") || 1));

  // Lọc dự án theo category INFRA
  const filteredProjects = PROJECTS.filter((p) => p.category === PROJECT_CATEGORIES.INFRA);
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-10">
      <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-6">Hạ Tầng</h2>
