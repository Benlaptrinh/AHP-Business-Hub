...
export default function ProjectOFFICE() {
  ...
  // Lọc dự án theo category OFFICE
  const filteredProjects = PROJECTS.filter((p) => p.category === PROJECT_CATEGORIES.OFFICE);
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-10">
      <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-6">Cao Ốc Văn Phòng</h2>
