...
export default function ProjectHEALTH_EDU() {
  const [params, setParams] = useSearchParams();
  const page = Math.max(1, Number(params.get("page") || 1));

  // Lọc dự án theo category HEALTH_EDU
  const filteredProjects = PROJECTS.filter((p) => p.category === PROJECT_CATEGORIES.HEALTH_EDU);
