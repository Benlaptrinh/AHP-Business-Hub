...
export default function ProjectINDUSTRIAL() {
  const [params, setParams] = useSearchParams();
  const page = Math.max(1, Number(params.get("page") || 1));

  // Lọc dự án theo category INDUSTRIAL
  const filteredProjects = PROJECTS.filter((p) => p.category === PROJECT_CATEGORIES.INDUSTRIAL);
